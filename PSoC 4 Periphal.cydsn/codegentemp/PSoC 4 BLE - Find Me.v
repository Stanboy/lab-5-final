// ======================================================================
// PSoC 4 BLE - Find Me.v generated from TopDesign.cysch
// 12/07/2016 at 18:24
...
module BLE_v1_20_0 (
	...
	cy_clock_v1_0
		#(.id("6b3d59e8-b9d5-4a09-b8b3-a91b2264e5b8/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_R_net;
	wire [0:0] tmpFB_0__Pin_R_net;
	wire [0:0] tmpIO_0__Pin_R_net;
	wire [0:0] tmpINTERRUPT_0__Pin_R_net;
	electrical [0:0] tmpSIOVREF__Pin_R_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_R
		 (.oe(tmpOE__Pin_R_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_R_net[0:0]}),
		  .io({tmpIO_0__Pin_R_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_R_net),
		  .interrupt({tmpINTERRUPT_0__Pin_R_net[0:0]}),
		  .annotation({Net_48}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 LED (
        .connect({
            Net_53,
            Net_50
        })
    );
    defparam LED.comp_name = "LED_v1_0";
    defparam LED.port_names = "A, K";
    defparam LED.width = 2;
	...
	wire [0:0] tmpOE__Pin_B_net;
	wire [0:0] tmpFB_0__Pin_B_net;
	wire [0:0] tmpIO_0__Pin_B_net;
	wire [0:0] tmpINTERRUPT_0__Pin_B_net;
	electrical [0:0] tmpSIOVREF__Pin_B_net;

	cy_psoc3_pins_v1_10
		#(.id("9bbf5f8e-0814-41a0-b06b-0bb6e61e9a0e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Pin_B
		 (.oe(tmpOE__Pin_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_B_net[0:0]}),
		  .io({tmpIO_0__Pin_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_B_net),
		  .interrupt({tmpINTERRUPT_0__Pin_B_net[0:0]}),
		  .annotation({Net_30}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_G_net;
	wire [0:0] tmpFB_0__Pin_G_net;
	wire [0:0] tmpIO_0__Pin_G_net;
	wire [0:0] tmpINTERRUPT_0__Pin_G_net;
	electrical [0:0] tmpSIOVREF__Pin_G_net;

	cy_psoc3_pins_v1_10
		#(.id("b84e4dc2-9327-4a51-b1f2-bd8504c64695"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Pin_G
		 (.oe(tmpOE__Pin_G_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_G_net[0:0]}),
		  .io({tmpIO_0__Pin_G_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_G_net),
		  .interrupt({tmpINTERRUPT_0__Pin_G_net[0:0]}),
		  .annotation({Net_31}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
