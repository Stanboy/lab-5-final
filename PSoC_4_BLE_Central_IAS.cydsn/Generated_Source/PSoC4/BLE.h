...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_SCAN_INTERVAL                (0x0050u)
    #define CYBLE_FAST_SCAN_WINDOW                  (0x0008u)
    ...
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MIN      (0x0040u)
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MAX      (0x0050u)
    #define CYBLE_GAPC_CONNECTION_SLAVE_LATENCY     (0x0000u)
    #define CYBLE_GAPC_CONNECTION_TIME_OUT          (0x0190u)
