// ======================================================================
// PSoC_4_BLE_Central_IAS.v generated from TopDesign.cysch
// 12/07/2016 at 17:18
...
module top ;
	...
	wire [0:0] tmpFB_0__User_Button_net;
	...
	cy_psoc3_pins_v1_10
		...
		User_Button
		 (.oe(tmpOE__User_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__User_Button_net[0:0]}),
	...
	cy_psoc3_pins_v1_10
		#(.id("aecd138b-ca0c-4749-b904-cc40dd349bbe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 R1_1 (
        .connect({
            Net_455,
            Net_453
        })
    );
    defparam R1_1.comp_name = "Resistor_v1_0";
    defparam R1_1.port_names = "T1, T2";
    defparam R1_1.width = 2;
